...
const Create = () => {
  ...
  async function formSubmit(e) {
    try {
      ...
      if (res.status === 404) {
        window.alert(
          "Error al crear receta! Por favor agregue una receta nueva y complete todos los campos requeridos."
        );
      } else {
      ...
      window.alert(
        "error al conectar con el servidor! no se pudo crear la receta"
      );
